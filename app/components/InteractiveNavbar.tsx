...
export default function InteractiveNavbar() {
  ...
  const testVideoUrl = "https://assets.mixkit.co/videos/preview/mixkit-white-cat-lying-among-the-grasses-close-up-2068-large.mp4";
    ...
    <>
              ...
              <div className="relative group">
                <div className="relative overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
                  <button
                    ...
                    className="relative w-32 h-20 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                  ...
                  >
                    <video
                      ...
                      aria-label="White cat video that plays on hover"
                    />
      ...
      {chatbotOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          {/* Modal */}
          <div 
            className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[80vh] flex flex-col overflow-hidden animate-in slide-in-from-bottom-10 duration-300"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div id="chatbot-description" className="sr-only">
              AI assistant chatbot. Type your message and press Enter to send. Press Escape to close.
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-500 to-blue-600 p-6 text-white">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={() => setChatbotOpen(false)}
                  className="text-white/80 hover:text-white text-xl transition-colors focus:outline-none focus:ring-2 focus:ring-white rounded"
              ...
              <div className="space-y-4">
                {messages.map((msg) => (
                  <div
                    ...
                    aria-label={`${msg.sender === 'user' ? 'You said' : 'Assistant said'}: ${msg.text}`}
                  >
                    <div
